...
- **待ち受けモード** — `/mail` の後そのまま5分間（既定）新着を見張り、コードが届いたら即投稿。
  見つかっても打ち切らず、時間いっぱい見張り続ける
...
3. コードを含むメールが届いたらその場で投稿します。**見つかっても打ち切らず、5分経つまで
   見張り続けます**（コードを再送した場合や、複数のサービスから届く場合に取りこぼさないため）
4. 5分経つと「✅ **待ち受けを終了しました。** ワンタイムパスワードを◯件お知らせしました。」
   または「⌛ **待ち受けを終了しました。** ワンタイムパスワードは届きませんでした。」で終わります
